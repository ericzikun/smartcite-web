...
const Result = () => {
  ...
  const rowSelection = {
    onChange: (selectedRowKeys, selectedRows) => {
      ...
      const list1 = [
        "Author: " +
          ...
          JSON.stringify(paperData[selectedRowKeys].authors[0].givenName)
            ...
            .replace('"', ""),
        "Reference: " +
          JSON.stringify(paperData[selectedRowKeys].title)
            .replace('"', "")
            .replace('"', "") +
          JSON.stringify(paperData[selectedRowKeys].year)
            .replace('"', "")
            .replace('"', ""),
        // ""
        "Citation Context: ",
      ...
      const list2 = [
        [
          "Citation Context: " +
            JSON.stringify(contextList[selectedRowKeys].text),
        ],
      ];
  ...
  return (
    <div className="component-wrap result">
      <div className="head-wrap">
        <div className="smartcite2">SmartCiteCon</div>
        <div className="upload-wrap2">
          <Button type="default" shape="round" disabled="true">
            ...
            {!isUploading && (
              <span>
                {localStorage.getItem("fileName") == ""
                  ? "Please select a pdf or xml file for citation context extraction"
                  : localStorage.getItem("fileName")}
              </span>
            )}
          </Button>
